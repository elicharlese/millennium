...
//!
//! [MenuBar][menu_bar] is used to created a Window menu on Windows and Linux.
//! On macOS it's used in the menubar.
//!
//! ```rust,ignore
...
impl MenuBar {
	/// Creates a new Menubar (Window) menu for platforms where this is
	/// appropriate.
	pub fn new() -> Self {
		Self(Menu {
...
pub enum MenuItem {
	...
	///
	/// THe first value is the applicatio name, and the second is its metadata.
	///
	/// ## Platform-specific
	///
	/// - **Windows / Android / iOS:** Unsupported
	...
	/// cut/copy/paste/undo lifecycle of events.
	///
	/// ## Platform-specific
	///
	/// - **Windows / Linux / Android / iOS:** Unsupported
	...
	/// An "redo" menu item; particularly useful for supporting the
	/// cut/copy/paste/undo lifecycle of events.
	///
	/// ## Platform-specific
	///
...
///
/// Whenever you receive an event arising from a particular menu, this event
/// contains a `MenuId` which identifies its origin.
