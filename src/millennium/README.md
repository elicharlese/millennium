...
This is the glue crate that holds everything together. It brings the runtimes, macros, utilities, and API into one final product. It reads the Millennium config file at compile time to bring in features and undertake the app configuration. It handles script injection (for polyfills/prototype revision) at runtime, hosts the API for systems interaction, and manages updates.
