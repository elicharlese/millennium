...
///
/// ```
/// use millennium::api::version::compare;
...
///
/// ```
/// use millennium::api::version::is_compatible;
...
pub fn is_compatible(first: &str, second: &str) -> crate::api::Result<bool> {
	...
	Ok(if second.major == 0 && first.major == 0 {
		...
		first.major == second.major && ((second.minor > first.minor) || (first.minor == second.minor && second.patch > first.patch))
	} else {
		false
	})
}
...
///
/// ```
/// use millennium::api::version::is_major;
...
///
/// ```
/// use millennium::api::version::is_minor;
...
///
/// ```
/// use millennium::api::version::is_patch;
...
///
/// ```
/// use millennium::api::version::is_greater;
